...
# For LA
root = r'/home/xiaojiang/researchProj/datasets/gsv-data/LA'
outshp = os.path.join(root, 'spatial-data/LA100m.shp')

# For Atlanta
root = '/home/xiaojiang/researchProj/datasets/gsv-data/Atlanta'
outshp = os.path.join(root, 'spatial-data/Atlanta100m.shp')
