...
# for San Antonio
root = r'/home/xiaojiang/researchProj/datasets/gsv-data/SanAntonio'
outshp = os.path.join(root, 'spatial-data/SanAntonio100m.shp')

# For baltimore
root = r'/home/xiaojiang/researchProj/datasets/gsv-data/Baltimore'
outshp = os.path.join(root, 'spatial-data/Baltimore100m.shp')
